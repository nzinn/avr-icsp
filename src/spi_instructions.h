...
SP_STATUS SPI_read_flash_addr_low(uint8_t addr_lsb, uint8_t addr_msb, uint8_t *low_bytes);
SP_STATUS SPI_read_flash_addr_high(uint8_t addr_lsb, uint8_t addr_msb, uint8_t *high_bytes);
